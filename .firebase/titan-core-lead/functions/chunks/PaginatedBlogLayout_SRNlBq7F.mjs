import { c as createComponent, b as createAstro, r as renderComponent, m as maybeRenderHead, a as renderTemplate, d as addAttribute } from './astro/server_DcBCas5z.mjs';
import 'piccolore';
import { c as $$, $ as $$Layout, a as $$Button } from './Layout_CXXdqrRG.mjs';
import { c as categories, $ as $$BlogPost } from './BlogPost_5KofPiMV.mjs';
import { g as getCollection } from './_astro_content_C5Ri5SWs.mjs';
import { $ as $$InnerHero } from './InnerHero_DDJ_fu-S.mjs';
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/ChevronLeft.astro", void 0);
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/ChevronRight.astro", void 0);
...
</p> </div> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> ${posts.map((post, index) => renderTemplate`<div> ${renderComponent($$result, "BlogPost", $$BlogPost, { "title": post.data.title, "excerpt": post.data.excerpt, "featuredImage": post.data.featuredImage || "", "publishDate": post.data.publishDate, "categories": post.data.categories || [], "slug": post.id, "index": index })} </div>`)} </div> ${posts.length === 0 && renderTemplate`<p class="text-center text-gray-500 py-8">No posts found in this category.</p>`} </section>`;
}, "/home/user/titan-core/src/components/blog/BlogList.astro", void 0);

const blogHeroImage = new Proxy({"src":"/_astro/blog-hero-2.BwhK2N9G.jpg","width":1408,"height":768,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/user/titan-core/src/assets/images/blog-hero-2.jpg";
							}
...
}, "/home/user/titan-core/src/components/blog/PaginatedBlogLayout.astro", void 0);

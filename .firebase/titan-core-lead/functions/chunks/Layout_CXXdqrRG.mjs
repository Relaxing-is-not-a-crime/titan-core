import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, b as createAstro, m as maybeRenderHead, d as addAttribute, r as renderComponent, f as renderSlot, e as renderScript, j as renderHead } from './astro/server_DcBCas5z.mjs';
import 'piccolore';
/* empty css                          */
...
const $$Logo = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a href="/"${addAttribute(["logo uppercase font-logo transition-colors duration-200 font-light", getLogoClass()], "class:list")}>  ${renderComponent($$result, "Image", $$Image, { "src": logo, "alt": "", "class": "hidden" })} <span class="font-bold">Titan</span> Core
</a>`;
}, "/home/user/titan-core/src/components/Logo.astro", void 0);
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/.Layout.astro", void 0);
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/ChevronDown.astro", void 0);
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/Menu.astro", void 0);
...
}, "/home/user/titan-core/node_modules/lucide-astro/dist/X.astro", void 0);
...
}, "/home/user/titan-core/src/components/ui/Button.astro", void 0);
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="fixed top-0 z-50 w-full left-0"> <div class="site-container mx-auto px-4 mt-4"> <div class="flex justify-between items-center bg-white py-4 rounded-lg px-4 border-black border"> ${renderComponent($$result, "Logo", $$Logo, {})} <nav class="relative flex items-center gap-2 lg:gap-8" aria-label="Site Navigation">  <ul class="hidden lg:flex lg:gap-8 items-center"> ${headerMenu.map((item, index) => renderTemplate`<li class="relative group"> <div class="flex items-center gap-1"> <a${addAttribute(item.link, "href")}${addAttribute([
    ...
    "aria-current"
  )}> ${child.name} </a> </li>`)} </ul>`} </div> </li>`)} </ul>  <div class="mt-8 pb-8"> ${renderComponent($$result, "Button", $$Button, { "href": ctaButton.link, "variant": "ghostLight" }, { "default": ($$result2) => renderTemplate`${ctaButton.name}` })} </div> </div> </nav> </div> </div> </header> ${renderScript($$result, "/home/user/titan-core/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/user/titan-core/src/components/Header.astro", void 0);
...
}, "/home/user/titan-core/src/components/Footer.astro", void 0);

const $$ThemeSwitcher = createComponent(($$result, $$props, $$slots) => {
  const themes = [
    { id: "zeus", label: "Zeus", desc: "Sky & Thunder" },
    // Royal blue & gold
    { id: "poseidon", label: "Poseidon", desc: "Ocean & Seas" },
    // Deep blues & teals
    { id: "hades", label: "Hades", desc: "Underworld" },
    // Dark purples & grays
    { id: "apollo", label: "Apollo", desc: "Sun & Light" },
    // Warm yellows & oranges
    { id: "artemis", label: "Artemis", desc: "Moon & Hunt" },
    // Silver & forest greens
    { id: "ares", label: "Ares", desc: "War & Fire" },
    // Reds & blacks
    { id: "athena", label: "Athena", desc: "Wisdom" },
    // Olive & golds
    { id: "hermes", label: "Hermes", desc: "Speed" },
    // Swift blues & silvers
    { id: "dionysus", label: "Dionysus", desc: "Festivity" },
    // Purple & wine reds
    { id: "demeter", label: "Demeter", desc: "Nature" }
    // Earth tones & greens
  ];
  return renderTemplate`${maybeRenderHead()}<div class="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-2 z-50" id="theme-switcher" data-astro-cid-dz5h74bc> <button class="flex items-center cursor-pointer justify-center w-10 h-10 rounded-md hover:bg-gray-100" id="theme-button" aria-label="Change theme" aria-haspopup="true" aria-expanded="false" aria-controls="theme-dropdown" data-astro-cid-dz5h74bc> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" aria-hidden="true" data-astro-cid-dz5h74bc> <path stroke-linecap="round" stroke-linejoin="round" d="M4.098 19.902a3.75 3.75 0 0 0 5.304 0l6.401-6.402M6.75 21A3.75 3.75 0 0 1 3 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 0 0 3.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.88-2.88c.438-.439 1.15-.439 1.59 0l3.712 3.713c.44.44.44 1.152 0 1.59l-2.879 2.88M6.75 17.25h.008v.008H6.75v-.008Z" data-astro-cid-dz5h74bc></path> </svg> </button> <div class="absolute bottom-full right-0 mb-2 w-64 bg-white rounded-lg shadow-lg overflow-hidden hidden mr-[-0.5rem]" id="theme-dropdown" role="menu" aria-labelledby="theme-button" data-astro-cid-dz5h74bc> ${themes.map((theme) => renderTemplate`<button${addAttribute(theme.id, "data-theme")} class="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center space-x-3 theme-option cursor-pointer" role="menuitem"${addAttribute(`Switch to ${theme.label} theme: ${theme.desc}`, "aria-label")} data-astro-cid-dz5h74bc> <div class="w-6 h-6 rounded-full relative overflow-hidden flex-shrink-0" aria-hidden="true" data-astro-cid-dz5h74bc> <div class="absolute top-0 left-0 right-0 h-1/2"${addAttribute(`background-color: var(--color-primary)`, "style")} data-astro-cid-dz5h74bc></div> <div class="absolute bottom-0 left-0 w-1/2 h-1/2"${addAttribute(`background-color: var(--color-secondary)`, "style")} data-astro-cid-dz5h74bc></div> <div class="absolute bottom-0 right-0 w-1/2 h-1/2"${addAttribute(`background-color: var(--color-accent)`, "style")} data-astro-cid-dz5h74bc></div> </div> <div class="flex flex-col" data-astro-cid-dz5h74bc> <span class="text-sm font-medium" data-astro-cid-dz5h74bc>${theme.label}</span> <span class="text-xs text-gray-500" data-astro-cid-dz5h74bc>${theme.desc}</span> </div> </button>`)} </div> </div> ${renderScript($$result, "/home/user/titan-core/src/components/ThemeSwitcher.astro?astro&type=script&index=0&lang.ts")} `;
}, "/home/user/titan-core/src/components/ThemeSwitcher.astro", void 0);
